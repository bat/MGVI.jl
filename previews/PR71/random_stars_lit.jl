#md # # Random Stars Example

#md # You can also download this example as a
#md # [Jupyter notebook](mgvi_random_stars.ipynb) and a plain
#md # [Julia source file](mgvi_random_stars.jl).
...
#jl savefig("random-stars-plot1.png")
#md savefig("random-stars-plot1.png")
#md # [![Plot](random-stars-plot1.png)](random-stars-plot1.png)
...
#jl savefig("random-stars-plot2.pdf")
#md savefig("random-stars-plot2.pdf")
#md savefig("random-stars-plot2.svg"); nothing # hide
#md # [![Plot](random-stars-plot2.svg)](random-stars-plot2.pdf)
...
#jl savefig("random-stars-plot3.png")
#md savefig("random-stars-plot3.png")
#md # [![Plot](random-stars-plot3.png)](random-stars-plot3.png)
...
#jl savefig("random-stars-plot4.pdf")
#md savefig("random-stars-plot4.pdf")
#md savefig("random-stars-plot4.svg"); nothing # hide
#md # [![Plot](random-stars-plot4.svg)](random-stars-plot4.pdf)
...
#jl savefig("random-stars-plot5.png")
#md savefig("random-stars-plot5.png")
#md # [![Plot](random-stars-plot5.png)](random-stars-plot5.png)
